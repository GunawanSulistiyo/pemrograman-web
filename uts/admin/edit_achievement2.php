  ...
  <br><br>
    ...
    ?>
            <tr>
              ...
              <td><?php echo $row["juara1"] ?></td>
              <td><?php echo $row["juara2"] ?></td>
              <td><?php echo $row["juara3"] ?></td>
                <a href="edit_achievement.php?id=<?php echo $row["id"] ?>" class="btn btn-info">Edit</a>
              </td>
            </tr>
     <?php 
      }
