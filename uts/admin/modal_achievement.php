                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-6"><b>Juara 1</b></div>
                                <div class="col-6"><span id="juara1"></span></div>
                            </div>
                            <div class="row">
                                <div class="col-6"><b>Juara 2</b></div>
                                <div class="col-6"><span id="juara2"></span></div>
                            </div>
                            <div class="row">
                                <div class="col-6"><b>Juara 3</b></div>
                                <div class="col-6"><span id="juara3"></span></div>
                            </div>
                        </div>
                    </div>
